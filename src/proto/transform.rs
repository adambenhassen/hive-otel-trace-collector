...
mod tests {
    ...
    fn test_transform_span() {
        ...
        let rows = transform_request(&request, "target-123");
        ...
        // Verify target_id is injected into both resource and span attributes
        assert_eq!(
    ...
    fn test_extract_attribute_value() {
        ...
        assert_eq!(
            extract_attribute_value(&string_val),
            Some("test".to_string())
        );
